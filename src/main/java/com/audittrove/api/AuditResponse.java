...
public record AuditResponse(
        ...
        String language) {
    /** language: raporun yazıldığı dil ("tr"/"en"); arayüz etiketlerini buna kilitler, cihaz diline değil. */
    @JsonCreator
    ...
    public AuditResponse(int riskScore, String scoreRationale, String summary, List<Risk> risks,
        ...
        this(riskScore, scoreRationale, summary, risks, recommendations, keyMetrics, advisorQuestions, references, null);
    }
